...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8900EB);
  late Color secondary = const Color(0xFF705D00);
  late Color tertiary = const Color(0xFF5331FF);
  late Color alternate = const Color(0xFF006E2D);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF9F3F3);
  ...
  late Color outline = const Color(0xFF7C757E);
  ...
  late Color primaryContainer = const Color(0xFFF0DBFF);
  late Color secondaryContainer = const Color(0xFFFFE16F);
  late Color tertiaryContainer = const Color(0xFFE4DFFF);
  late Color alternateContainer = const Color(0xFF76FD93);
  late Color onPrimaryContainer = const Color(0xFF2C0051);
  late Color onSecondaryContainer = const Color(0xFF221B00);
  late Color onTertiaryContainer = const Color(0xFF160066);
  late Color onAlternateContainer = const Color(0xFF002109);
